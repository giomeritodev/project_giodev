                ...
                <Dialog>
                    <DialogTrigger asChild>
                        <div className="flex justify-between">
                            <div>
                                <h1>Pagina de status de pagamento</h1>
                            </div>
                            <div>
                                <Button>
                                    <PlusCircle  />
                    ...
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Novo status de pagamento</DialogTitle>
                            <DialogDescription>Criar um novo cadastro de status de pagamento no sistema</DialogDescription>
                        </DialogHeader>

                            <form 
                                onSubmit={(e) => handleCreateStatusPayment(e)}
                                className="space-y-6"
                            >       
                                <div className="grid grid-cols-4 items-center text-right gap-3">
                                    <Label htmlFor="name">Status de pagamento</Label>
                                    <Input
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow key={st.id}>
                                            ...
                                            <TableCell className="flex justify-end">
                                                ...
                                                <AlertDialogVisao 
                                                    id={Number(st.id)} 
                                                    deleteItem={() => deleteStatusPayment(Number(st.id))}
                                                    item={`${st.name}`}
                                                >                                                    
